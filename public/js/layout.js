...
function renderSidebar(currentUser) {
    ...
    sidebarContainer.innerHTML = `
        ...
        <!-- Sidebar -->
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 flex w-64 -translate-x-full flex-col bg-slate-900 text-white transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0">
...
function renderHeader(currentUser) {
    ...
    headerContainer.innerHTML = `
        <header class="sticky top-0 z-20 flex h-16 w-full flex-shrink-0 items-center justify-between border-b bg-white px-4 lg:px-6">
